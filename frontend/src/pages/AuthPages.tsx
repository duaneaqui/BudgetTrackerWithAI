  ...
  return (
    <div className="grid min-h-screen bg-shell lg:grid-cols-[1.02fr_0.98fr]">
      <section className="flex items-center px-6 py-10 sm:px-10 lg:px-16">
        <div className="motion-page w-full max-w-md">
          ...
          {mode === "login" && (
            <div className="motion-rise mb-6 rounded-md border border-brand/25 bg-white p-4 shadow-soft">
      ...
      <section className="auth-spotlight hidden bg-ink p-10 text-white lg:flex lg:flex-col lg:justify-between">
        <div className="grid grid-cols-2 gap-4">
          {[
            ...
            <div key={label} className="motion-card rounded-md border border-white/15 bg-white/10 p-5">
        ...
        <div>
          <div className="mb-4 flex h-2 w-24 overflow-hidden rounded-full bg-white/15">
            <div className="h-full w-10 rounded-full bg-mango pulse-dot" />
          </div>
